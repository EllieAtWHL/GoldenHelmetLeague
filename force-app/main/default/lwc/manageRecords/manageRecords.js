...
export default class ManageRecords extends NavigationMixin(LightningElement) {
  ...
  openBoard() {
    this.navigateToPage(
      "https://goldenhelmetleague-dev-ed.develop.my.site.com/draft"
  ...
  openControls() {
    ...
    this.navigateToPage(
      "https://goldenhelmet2-dev-ed.my.site.com/draft/s/commissioner"
    ); //TODO: This doesn't work as it doesn't log the user in properly
  }
